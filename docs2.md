...
# 📝 التحديثات الأخيرة (1 أبريل 2026)

## التعديلات الجديدة

### ✅ 1. تحديث رسالة خطأ رقم التليفون
**الملفات المعدلة:**
- `src/app/pages/CustomersPage.tsx`
- `src/app/pages/SuppliersPage.tsx`

**التغيير:**
- **الرسالة القديمة:** "رقم التليفون يجب أن يبدأ بـ 010 أو 011 أو 012 أو 015 ويتكون من 11 رقم"
- **الرسالة الجديدة:** "رقم الموبايل غير صحيح"
...
**الوصف:**
- يقبل أرقام تبدأ بـ 010 أو 011 أو 012 أو 015
- يجب أن يكون 11 رقم بالضبط
- يتم التحقق في صفحات العملاء والموردين

---

### ✅ 2. إزالة قسم "التقنيات المستخدمة" من الإعدادات
**الملف المعدل:**
- `src/app/pages/SettingsPage.tsx`

**التغيير:**
- تم إزالة قسم "التقنيات المستخدمة" من تبويب "النظام"
- تم حذف الـ Badges (React, TypeScript, Electron, SQLite, Tailwind CSS)

**الوصف:**
- تبويب النظام الآن يحتوي فقط على:
  - إصدار النظام
  - المبرمج (Abdelrahman Khaled Mohamed)
